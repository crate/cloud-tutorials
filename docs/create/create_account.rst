...
Once you've filled in your information, select *Sign up*.

Shortly after, you should receive a confirmation e-mail that includes your
six-digit verification code.

Copy your verification code from the e-mail and paste it into the text input
field on the signup page.

Select *Confirm*, to complete your new CeateDB Cloud user account.

You should now see the CrateDB Cloud Console.

If so, then you're already logged in to your account.

You have successfully created your CrateDB user account.
